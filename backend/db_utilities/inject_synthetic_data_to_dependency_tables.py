...
import pycountry
from backend.db_utilities.create_db_schemas import transaction_status, payment_method, mfa_status, customer, country, currency, title, pvtlp_user
from backend.db_utilities.global_db_variables import connection
countries = pycountry.countries

# Insert records
inserts_array = [
    insert(pvtlp_user).values([
        {"pvtlp_username_pk": "admin50", 'is_admin': True}
    ]),
